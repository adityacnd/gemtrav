	...
	<body>
		...
		<div id="container">
            ...
            <div class="update-notification2" id="updateNotification2">
                ...
                <span id="updateText">Web telah diupdate. <a href="index.php?page=update" style="color: #FDE; text-decoration: underline;">Lihat update</a></span>
                <span class="close-button" onclick="closeNotification3()"><i class="fa fa-times" aria-hidden="true"></i></span>
            </div>
			<div id="content">
