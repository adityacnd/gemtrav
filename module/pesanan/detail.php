...
<!--		<p>Silahkan Lakukan pembayaran ke Bank BCA DIGITAL<br/>-->
<!--		   Nomor Account : 0000-9999-8888 (A/N Gemilang Travel).<br/>-->
<!--		   Setelah melakukan pembayaran silahkan lakukan konfirmasi pembayaran -->
<!--		   <a href="<?php echo BASE_URL."index.php?page=my_profile&module=pesanan&action=konfirmasi_pembayaran&pesanan_id=$pesanan_id"?>">Disini</a>.<br/>-->
		   
<!--		</p>-->
<!--		<button onclick="takeScreenshot()" style="background-color: orange;border:none;display: flex;justify-content:flex-end">cetak tiket</button>-->
<!--		<h5>-->
<!--		    kendala transaksi? <br/>Hubungi admin(wa) -->
<!--		    <a href="https://wa.me/6281246575092?text=Halo%20admin%20gemilang%20travel%0Asaya%20terkendala%20pesanan%20saya%0Aatas%20nama%20..%20dengan%20id%20pesananan%20..%0A">Disini</a>-->
<!--		</h5>-->
<!--	</div>-->
...
<div id="frame-faktur" style="<?php echo $backgroundImage; ?>">
	...
	<table>
		...
		<tr>
			<td>Status</td>
			<td>:</td>
			<td><button onclick="takeScreenshot()" style="background-color: orange;border:none"><?php echo $arrayStatusPesanan[$status]; ?></button></td>
...
<table class="table-list">
	...
	<!--<tr>-->
	<!--	<td class="kiri" colspan="5"><b>Status Pembayaran:</b> <?php echo $arrayStatusPesanan[$status]; ?></td>-->
	<!--</tr>-->
