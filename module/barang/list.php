<div id="frame-tambah">
	<a href="<?php echo BASE_URL."index.php?page=my_profile&module=barang&action=form"; ?>" class="tombol-action">+ Tambah Paket Baru</a>
</div>
...
<?php
	...
	if(mysqli_num_rows($query) == 0){
		echo "<h3>Saat ini belum ada paket travel di dalam tabel</h3>";
	}else{
